...
INSERT INTO `orders` (`id`, `listing_id`, `user_id`, `address`, `status`) VALUES
(1, 1, 1, '1231q2wedaserfdrghedth', 'processing');
...
(1, 'jimmy', '$2y$10$eVb1fmzQJF/UE0HcBPYxreS/i7PE5qYKFZdYwT6P.VvnudR1kccgi', 'Jimmy', 'Cook', 'fake@fake.com', 10, 0);
